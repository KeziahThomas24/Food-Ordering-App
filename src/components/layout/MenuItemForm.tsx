...
const MenuItemForm: React.FC<MenuItemFormProps> = ({ onSubmit, menuItem }) => {
  ...
  return (
    <form
      onSubmit={ev =>
        onSubmit(ev, {
          image, name, description, basePrice, sizes, extraIngredientPrices, category,_id
        })
      }
    ...
    >
      ...
      >
        ...
        <div className="grow">
          ...
          <select value={category._id} onChange={ev => setCategory(categories.find(c => c._id == String(ev.target.value)) || {} as Category)}>
